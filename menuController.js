...
export async function gettingMeals() {
  try {
    const response = await fetch("https://resturant1.onrender.com");
    if (!response.ok) {
...
export async function deleting(params) {
  ...
  try {
    await fetch("https://resturant1.onrender.com/delete/" + params, {
      method: "DELETE",
      headers: {
...
export async function addingToCart(addedMeal) {
  ...
  try {
    await fetch("https://resturant1.onrender.com/addedToCart", {
      method: "post",
      headers: {
        "Content-Type": "application/json",
...
export async function getAddedMeals() {
  ...
  try {
    const res = await fetch("https://resturant1.onrender.com/getAddedMeals");
...
export async function deletingAddedMeal(params) {
  ...
  try {
   const res = await fetch("https://resturant1.onrender.com/deleteAddedMeal/" + params, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
      },
...
export async function updateMeal(params,objToUpdate) {
  ...
  try {
   const res = await fetch("https://resturant1.onrender.com/changeMeal/" + params, {
      method: "put",
      headers: {
        "Content-Type": "application/json",
      },
